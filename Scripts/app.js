...
function createBoard() {
    ...
    for (let i = 1; i < 9; i++) {
        ...
        for (let j = 1; j < 10; j++) {
            ...
            //else {
            //    if (i == 1) {
            //        boardHTML += "<div id='" + (i + "" + j) + "' class='timer'><p class='rankNumber'>10:00</p></div>";
            //    }
            //    else if (i == 8) {
            //        boardHTML += "<div id='" + (i + "" + j) + "' class='timer'><p class='rankNumber'>10:00</p></div>";
            //    }
...
function chooseSide(side) {
    ...
    if (gameOver == false && (side == "White" || side == "Black")) {
        whitewin = 11;
        GameNoResult();
...
function drawBoard() {
    ...
    if (Board.Side == "White") {
        ...
        for (let i = 8; i >= 1; i--) {
            //if (i == 8) {
            //    document.getElementById(i + "" + 1).innerHTML += "<p class='timer' id='topTimer'>10:00</p> <p class='rankNumber'>" + (8 - i + 1) + "</p>";
            //}
            //else if (i == 1) {
            //    document.getElementById(i + "" + 1).innerHTML += "<p class='timer' id='bottomTimer'>10:00</p> <p class='rankNumber'>" + (8 - i + 1) + "</p>";
            //}
            //else {
    ...
    if (Board.Side == "Black") {
        ...
        for (let i = 8; i >= 1; i--) {
            //if (i == 8) {
            //    document.getElementById(i + "" + 1).innerHTML += "<p class='timer' id='topTimer'>10:00</p> <p class='rankNumber'>" + i + "</p>";
            //}
            //else if (i == 1) {
            //    document.getElementById(i + "" + 1).innerHTML += "<p class='timer' id='bottomTimer'>10:00</p> <p class='rankNumber'>" + i + "</p>";
            //}
            //else {
    ...
    //document.getElementById('topTimer').innerHTML = computerMinute + ":" + computerSecond;
    //document.getElementById('bottomTimer').innerHTML = playerMinute + ":" + playerSecond;
}
...
function resetTurnsAndAnalyzeCheckmates() {
    ...
    if (Board.Turn == "White") {
        ...
        if (Board.BlackCheck) {
            ...
            if (gameOver == true && getAllMovesExceptKing(Board, "Black").length == 0) {
                whitewin = 3;
                GameNoResult();
            }
        }
        ...
        if (Board.WhiteCheck) {
            ...
            if (gameOver == true && getAllMovesExceptKing(Board, "White").length == 0) {
                whitewin = 3;
                GameNoResult();
            }
        }
    ...
    if (Board.CheckMateOnBlack) {
        ...
        gameOver = true;
        gameStarted = false;
        if (gameOver == true && Board.Side == "Black") {
            whitewin = 5;
            GameNoResult();
        }
        if (gameover == true && board.side == "white") {
            whitewin = 6;
            GameNoResult();
        }
    }
...
function drawGame() {
    ...
    if (!gameOver && gameStarted) {
        ...
        if (gameOver == true && (OpponentSide == "Black" || OpponentSide == "White")) {
            whitewin = 3;
        }
    }
    GameNoResult();
...
function makePopUp(event) {
    ...
    let popUpBodyText = "<h1 class='PopUpBodyText'>Select Side:</h1>";
    let whiteButton = "<button onclick=chooseSide('White') class='ChooseSideButton' id='whitechoose' ><img src='Images/Pieces/WhiteKing.png' height='50vw'></button>";
    let blackButton = "<button onclick=chooseSide('Black') class='ChooseSideButton' id='blackchoose'><img src='Images/Pieces/BlackKing.png' height='50vw'></button>";
    let difficultyText = "<h2 class='PopUpBodyText' style='margin-top: 8px;'>Select Level:</h2>"
    ...
    let hard = "<button onclick=chooseDifficulty(4) class='ChooseSideButton DifficultyButton'> Hard </button>";

    let themeText = "<h2 class='PopUpBodyText' style='margin-top: 8px;'>Select Theme:</h2>";

    
    let brownTheme = "<button onclick=setTheme('Blue') class='brownButton'></button>";
    let blueTheme = "<button onclick=setTheme('Brown') class='blueButton'></button>";
